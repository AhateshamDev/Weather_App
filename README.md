...
🌤️ Real-time weather data using API<br/>
🎞️ Dynamic and animated UI based on weather conditions<br/>
🔍 City-based search<br/>
📱 Fully responsive on all screen sizes<br/>
⚡ Lightweight & framework-free<br/>
🌡️ Displays temperature, humidity, wind speed, and conditions<br/>
🎨 Smooth transitions & clean design

🛠️ Tech Stack
    
HTML5<br/>
CSS3 (Animations + Responsive Layouts)<br/>
JavaScript (Fetch API)<br/>
OpenWeatherMap API (or whatever API you used)
